"""
MOLE Constants - Paths, certificates, and templates
"""
...
# DNS over TLS (disabled by default)
DOT_ENABLED=false

# HTTP Proxy (disabled by default)
PROXY_ENABLED=false

# HTTP Control API (disabled by default)
