...
- **`grafana-dashboard.json`** — 24-panel Grafana dashboard organised in
  six rows: at-a-glance KPI strip, VPN renewal lifecycle, handshake +
  port-forward keepalives, VPN tunnel throughput paired with NAT-PMP
  failure-by-country, DNS throughput / latency / errors, and cache +
